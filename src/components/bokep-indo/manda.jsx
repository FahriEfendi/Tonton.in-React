...
const RaraNadifa = ({ videoId }) => {
    ...
    const getCharId = async () => {
      try {
        const response = await axios.get(
          `http://localhost:8080/getvideos/7e60b35f-a9cc-4301-8bbb-2aa330822471`
        );
  ...
  const handleLikeClick = async () => {
    ...
    if (liked[videoId]) {
      try {
        const response = await fetch(`http://localhost:8080/videos/declike/7e60b35f-a9cc-4301-8bbb-2aa330822471`, {
          method: 'PUT',
        });
        if (!response.ok) {
      ...
      if (dislike && dislike[videoId]) {
        ...
        try {
          const response = await fetch(`http://localhost:8080/videos/incdislike/7e60b35f-a9cc-4301-8bbb-2aa330822471`, {
            method: 'PUT',
          });
          if (!response.ok) {
      ...
      try {
        const response = await fetch(`http://localhost:8080/videos/inclike/7e60b35f-a9cc-4301-8bbb-2aa330822471`, {
          method: 'PUT',
        });
        if (!response.ok) {
          throw new Error('Failed to like video');
  ...
  const handleDislikeClick = async () => {
    ...
    if (disliked[videoId]) {
      try {
        const response = await fetch(`http://localhost:8080/videos/decdislike/7e60b35f-a9cc-4301-8bbb-2aa330822471`, {
          method: 'PUT',
        });
        if (!response.ok) {
            ...
            <div className="mx-auto max-w-full sm:max-w-screen-lg py-6 sm:px-6 lg:px-8">
              <div className="relative h-0" style={{ paddingBottom: "56.25%" }}>
                <iframe
                  ...
                  src="https://d0000d.com/e/mk6f1qcfi1e8"
